export const activities = [
  ...
  {
    id: "7",
    title: "Surfing in Miami",
    category: "Surfing",
    area: "Miami",
    country: "USA",
    description:
      "Immerse yourself in the rhythmic dance of the Atlantic waves as you surf the pristine shores of Miami. Feel the energy of the ocean beneath your board, where each crest and break becomes a moment of pure exhilaration. Miami, a haven for surfers, invites you to ride the tides and embrace the artistry of the sea.",
    image:
      "https://images.unsplash.com/photo-1526772662000-3f88f10405ff?q=80&w=1548&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    lat: 43.6584045,
    lng: -1.4262382,
  },
  {
    ...
    description:
      "Immerse yourself in the rhythmic dance of the Atlantic waves as you surf the pristine shores of Miami. Feel the energy of the ocean beneath your board, where each crest and break becomes a moment of pure exhilaration. Miami, a haven for surfers, invites you to ride the tides and embrace the artistry of the sea.",
    image:
      "https://images.unsplash.com/photo-1532384374-bcd16cf1d198?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    lat: 43.6584045,
    lng: -1.4262382,
  },
  {
    id: "9",
    title: "Paddelling on the Alster",
    category: "Paddeling",
    area: "Hamburg",
    country: "Germany",
    description:
      "Embark on a serene journey through the heart of Hamburg, where the tranquil waters of the Alster beckon you to paddle away into a world of tranquility and wonder. As you glide along the glassy surface, the citys skyline stands tall, mirrored perfectly in the gentle ripples below, a breathtaking symphony of architecture and nature.",
    image:
      "https://images.unsplash.com/photo-1532384374-bcd16cf1d198?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    lat: 53.559429,
    lng: 10.00888,
  ...
  {
    id: "10",
    title: "Peddelling on the Alster",
    category: "Paddeling",
    area: "Hamburg",
    country: "Germany",
    description:
...
// Water: Surfsport, Sailing, Swimming, Paddeling(x), Diving

// Winter: Skiing, tobogganing, Ice skating, Snowboarding,

// Mountains: Climbing,  mountaineering, Abseiling,

// Biking: Mountainbiking, Cycling

// Hiking: Strolling, Walking, Jogging, Hiking,

// Extrem: Paragliding, Bungeejumping, Motorcross, Rafting,

// Indoor: Curling, Bouldern, Ice Hockey,
